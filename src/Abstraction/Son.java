...
public class Son extends Parent{
    Son(String careerName, String foodName, String teamName, int salary,String partnerName,int partnerAge) {
    ...
    public void choosePartner() {
        System.out.println("My partner is "+partnerName+" And her age is "+partnerAge);
    }
}
